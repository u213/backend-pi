...
public class EntidadP {
	...
	public EntidadP(String idPersona, TipoDocumento tipoDocumento, String denominacion, String direccion, String email,
	...
	public String toString() {
		return "EntidadP [idPersona=" + idPersona + ", tipoDocumento=" + tipoDocumento + ", denominacion="
